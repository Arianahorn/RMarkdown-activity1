...
## **Activity Overview**
To practice using R markdown, you will run the .RMD file provided here. Read through each line to see what it is doing. Feel free to modify the .RMD file to enhance the output document, but that is not required.
